...
export const DatRange = (props: Props) => (
  <DatItemRange>
    ...
    <RangeInput
      ...
      step={props.step}
      onMouseDown={(event) =>
        props.onChangeStart && props.onChangeStart(Number(event.currentTarget.value))
      }
      onMouseUp={(event) =>
        props.onChangeComplete && props.onChangeComplete(Number(event.currentTarget.value))
      }
    />
    ...
    <NumberInput
      ...
      value={props.value}
      onChange={(event) =>
        typeof props.onChange === 'function' && props.onChange(Number(event.target.value))
      }
