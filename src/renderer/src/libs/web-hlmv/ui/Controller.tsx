 ...
 */
export const Controller = (props: Props): React.JSX.Element => {
            ...
            <React.Fragment>
              <DatFolder title="Animation">
                ...
                <DatNumber
                  label="Frames"
                  disabled
                  value={modelData.sequences[activeSequenceIndex].numFrames}
                />
                <DatNumber
                  label="FPS"
                  disabled
                  value={modelData.sequences[activeSequenceIndex].fps}
                />
                <DatNumber
                  label="Duration (sec)"
                  disabled
              ...
              <DatFolder title="Body parts">
                {modelData.bodyParts.map((bodyPart, bodyPartIndex) => (
                  <DatSelect
                    ...
                    items={props.modelData!.subModels[bodyPartIndex].map(
