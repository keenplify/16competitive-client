 ...
 */
export const BackgroundContainer = (props: Props): React.JSX.Element => {
  const [color, setColor] = React.useState(
    () => localStorage.getItem(LOCAL_STORAGE_KEY) || INITIAL_UI_BACKGROUND
  )
  ...
  return (
    <React.Fragment>
      {props.children({ backgroundColor: color }, { setBackgroundColor: setColor })}
    </React.Fragment>
  )
}
