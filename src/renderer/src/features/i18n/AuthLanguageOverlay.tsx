...
export function AuthLanguageOverlay(): JSX.Element | null {
  ...
  return (
    <div className="fixed top-4 right-4 z-[90] flex max-w-[calc(100vw-2rem)] items-center gap-2  border border-white/10 bg-neutral-950/85 p-1.5 text-white shadow-xl backdrop-blur-md sm:top-6 sm:right-6">
        ...
        {SUPPORTED_LANGUAGES.map((option) => {
          ...
          return (
            <button
              ...
              className={`  px-2.5 py-1.5 text-xs font-semibold transition sm:px-3 ${
                selected
