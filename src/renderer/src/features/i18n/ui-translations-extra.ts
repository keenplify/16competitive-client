...
const ru: Record<string, string> = {
  ...
  '. The launcher will launch Counter-Strike and connect automatically.':
    '. Лаунчер запустит Counter-Strike и подключится автоматически.',
  ...
  'Enter a username with 3–32 letters, numbers, or underscores.':
    'Введите имя из 3–32 букв, цифр или подчеркиваний.',
...
const tl: Record<string, string> = {
  ...
  '. The launcher will launch Counter-Strike and connect automatically.':
    '. Auto ila-launch ng launcher ang Counter-Strike at magko-connect.',
  ...
  'Enter a username with 3–32 letters, numbers, or underscores.':
    'Mag-enter ng username na 3–32 letters, numbers, o underscores.',
