...
const english = {
  ...
  'gift.welcomeMessage': "We truly appreciate you playing the early alpha release of 1.6 Competitive! As a welcome gift, please select one of the rewards below.",
...
const russian: Record<TranslationKey, string> = {
  ...
  'gift.welcomeMessage': "Спасибо, что играете в раннюю альфа-версию 1.6 Competitive! В качестве приветственного подарка выберите одну из наград ниже.",
...
const taglish: Record<TranslationKey, string> = {
  ...
  'gift.newPlayerReward': "New player reward",
  'gift.specialReward': "Special reward",
  'gift.welcomeMessage': "Maraming salamat sa paglalaro ng early alpha release ng 1.6 Competitive! Bilang welcome gift, pumili ng isa sa mga reward sa ibaba.",
...
const thai: Record<TranslationKey, string> = {
  ...
  'gift.welcomeMessage': "ขอบคุณมากที่ร่วมเล่น 1.6 Competitive เวอร์ชันอัลฟ่าช่วงแรก! เพื่อเป็นของขวัญต้อนรับ โปรดเลือกหนึ่งรางวัลด้านล่าง",
...
const indonesian: Record<TranslationKey, string> = {
  ...
  'gift.welcomeMessage': "Terima kasih banyak telah memainkan rilis early alpha 1.6 Competitive! Sebagai hadiah selamat datang, silakan pilih salah satu hadiah di bawah ini.",
...
const portuguese: Record<TranslationKey, string> = {
  ...
  'gift.welcomeMessage': "Agradecemos muito por jogar a versão early alpha de 1.6 Competitive! Como presente de boas-vindas, escolha uma das recompensas abaixo.",
